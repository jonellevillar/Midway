...
.bitty[
- Delays caused when NORMENT projects were moved to secure platform (TSD). <br> <br>
- The data available to us is derived from one blood sample. <br> <br>
- Realistically, we can´t control for all environmental factors. <br> <br>
...
.enlarge[This is the dataset we will be using for the projects.]
...
.bitty[
**In DNAm studies, correcting for cell-type proportions will reduce epigenetic variation associated with time-of-blood draw and circadian cycling of white blood cells.** 
]
