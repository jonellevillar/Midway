...
###**Specific aims**
.bitty[
1. **Paper 1**: Is the association of SCZ vs. controls on cell-type proportions impacted by time-of-blood draw? <br> <br />
2. **Paper 2**: What are common and specific DNAm marks are seen in psychosis following antipsychotic drugs treatment? <br> <br />
3. **Paper 3**: Do we see disorder specific DNAm of SCZ vs. BPD? <br> <br />
4. **Paper 3**: Are these disorder specific DNAm marks associated with development in SCZ & BPD? 
]  
...
1. Remove CpGs associated with antipsychotics from Project 2 <br> <br>
1. Model: DNAm ~ SCZ_BDP + Age + Sex + Smoking_score + eCells + Technical +𝜺<br> <br>
